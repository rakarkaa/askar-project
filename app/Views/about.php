...
<body>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4">
            <img src="<?php echo base_url('public/assets/img/askartim.png'); ?>" class="img-fluid" alt="">
          </div>
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              ...
              <div class="testimonial-item">
                ...
                <div>
                  <img src="<?php echo base_url('public/assets/img/mastommy.png'); ?>" class="testimonial-img" alt="">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile mt-auto">
                  <img src="<?php echo base_url('public/assets/img/testimonials/saribayu.png'); ?>" class="testimonial-img" alt="">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile mt-auto">
                  <img src="<?php echo base_url('public/assets/img/testimonials/anggita.png'); ?>" class="testimonial-img" alt="">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile mt-auto">
                  <img src="<?php echo base_url('public/assets/img/testimonials/erdzy.png'); ?>" class="testimonial-img" alt="">
                  <h3>Erdzy & Riady</h3>
                  <h4>Clien</h4>
                </div>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile mt-auto">
                  <img src="public/assets/img/testimonials/ilmi.png" class="testimonial-img" alt="">
                  <h3>Ilmi & Fiqi</h3>
                  <h4>Clien</h4>
                </div>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile mt-auto">
                  <img src="public/assets/img/testimonials/zaza.png" class="testimonial-img" alt="">
                  <h3>Zaza & Fikri</h3>
                  <h4>Clien</h4>
                </div>
              </div>
  ...
  <footer id="footer" class="footer">
    <div class="container">
      ...
      <div class="credits">
        2024
        <link href="<?php echo base_url() . 'https://askarphoto.com/'; ?>"> Inc </a>
      </div>
    </div>
  </footer><!-- End Footer -->
