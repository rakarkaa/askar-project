...
<head>
  ...
  <title>Askar Login Admin</title>
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css">
  <link href="<?php echo base_url(); ?>public/assets/css/login.css" rel="stylesheet" type="text/css">
...
<style type="text/css">
    ...
    <form method="post" action="<?php echo base_url('Admin/log');?>" class="log-in" autocomplete="off" enctype="multipart/form-data"> 
      ...
      <div class="floating-label">
        <input placeholder="Username" type="text" name="uname" id="email" autocomplete="off">
