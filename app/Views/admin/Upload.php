        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="#!"> <?php $session = session(); echo $_SESSION['nama']; ?></a></li>
                    <li>
        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="<?= base_url('Admin/Logout') ?>"">
                            <div class="sb-nav-link-icon"><i class="fa fa-window-close"></i></div>
                            Logout
                        </a>
                    </div>
                </div>
                <div class="sb-sidenav-footer">
                    ...
                    <?php $session = session(); echo $_SESSION['nama']; ?>
                </div>
            </nav>
        </div>
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                  ...
                  <div class="dz-default dz-message" input type="file" name='images[]' multiple="" ><span>Drop files here to upload</span></div></form>
