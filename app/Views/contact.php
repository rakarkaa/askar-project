        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-3">
            <div class="info-item d-flex">
              ...
              <div>
                <h4>Location:</h4>
                <p>De’khirani Village Blok F4 Tapos Depok</p>
              </div>
            </div>
          </div><!-- End Info Item -->
            ...
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              <div class="row">
                ...
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="email" class="form-control" name="email" id="email" placeholder="Your Instagram" required>
                </div>
                <div class="col-md-6 form-group mt-3">
                  <input type="text" name="name" class="form-control" id="name" placeholder="Choice Your Package" required>
                </div>
                <div class="col-md-6 form-group mt-3 mt-md-3">
                  <input type="email" class="form-control" name="email" id="email" placeholder="Location" required>
                </div>
                <div class="col-md-6 form-group mt-3">
                  <input type="text" name="name" class="form-control" id="name" placeholder="Budget" required>
                </div>
                <div class="col-md-6 form-group mt-3 mt-md-3">
